...
/**
 * @author bzran
 * @description Redis实例的创建、更新、查询、列举、删除
 */
public class InstanceSample {
     ...
     */
    private final static String resourcePath = "/api/v1/providers/Aliyun/products/Redis/resources/DBInstance";
    ...
    private static String createInstance() throws Exception {
        ...
        String resourceAttributes = "{\"DBInstanceName\":\"ccapi-test\",\"InstanceClass\":\"redis.master.micro.default\",\"ZoneId\":\"cn-zhangjiakou-a\",\"VSwitchId\":\"vsw-8vb68mghftv81ceaxxxxx\",\"EngineVersion\":\"4.0\",\"NetworkType\":\"VPC\",\"InstanceType\":\"Redis\",\"Capacity\":256}";
        //资源属性及其对应值
    ...
    private static boolean updateInstance(String resourceId) throws Exception {
        ...
        //资源属性及其对应值(json串,部分属性需改为自己账号对应的值)
        String resourceAttributes = "{\"DBInstanceName\":\"ccapi-test2\",\"InstanceClass\":\"redis.master.small.default\"}";
        //资源属性及其对应值
        Map<String, Object> resourceAttributeMap = JSONObject.parseObject(resourceAttributes,Map.class);
