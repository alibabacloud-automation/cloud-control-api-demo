...
/**
 * @author bzran
 * @description 混合云备份存储库的创建、更新、查询、列举、删除
 */
public class VaultSample {
     ...
     */
    private final static String resourcePath = "/api/v1/providers/Aliyun/products/HBR/resources/Vault";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //创建Redis实例
            String instanceId = createVault();
            //更新Redis实例
            boolean update = updateVault(instanceId);
            //查询Redis实例
            String instance = getVault(instanceId);
            System.out.println(instance);
            //列举Redis实例
            String instances = listVaults();
            System.out.println(instances);
            //删除Redis实例
            boolean delete = deleteVault(instanceId);
     ...
     * 创建混合云备份存储库
     */
    private static String createVault() throws Exception {

        //资源属性及其对应值(json串,部分属性需改为自己账号对应的值)
        String resourceAttributes = "{\"VaultName\":\"cctest\",\"VaultType\":\"STANDARD\",\"Description\":\"cctest\",\"Tags\":[{\"TagKey\":\"cckey1\",\"TagValue\":\"ccvalue1\"},{\"TagKey\":\"cckey2\",\"TagValue\":\"ccvalue2\"}]}";
        //资源属性及其对应值
     ...
     * 更新混合云备份存储库
     */
    private static boolean updateVault(String resourceId) throws Exception {

        //资源属性及其对应值(json串,部分属性需改为自己账号对应的值)
        String resourceAttributes = "{\"Description\":\"cctest2\",\"Tags\":[{\"TagKey\":\"cckey2\",\"TagValue\":\"ccvalue2\"},{\"TagKey\":\"cckey3\",\"TagValue\":\"ccvalue3\"}]}";
        //资源属性及其对应值
        Map<String, Object> resourceAttributeMap = JSONObject.parseObject(resourceAttributes,Map.class);
     ...
     * 查询混合云备份存储库
     */
    private static String getVault(String resourceId) throws Exception {
     ...
     * 列举混合云备份存储库
     */
    private static String listVaults() throws Exception {
     ...
     * 删除混合云备份存储库
     */
    private static boolean deleteVault(String resourceId) throws Exception {
