...
/**
 * @author bzran
 * @description 图数据库实例的创建、更新、查询、列举、删除
 */
public class DBInstanceSample {
     ...
     */
    private final static String resourcePath = "/api/v1/providers/Aliyun/products/GraphDatabase/resources/DbInstance";
    ...
    private static String createInstance() throws Exception {
        ...
        String resourceAttributes = "{\"DbVersion\":\"1.0\",\"DbInstanceNetworkType\":\"VPC\",\"DbNodeStorage\":20,\"DbInstanceStorageType\":\"cloud_essd\",\"DbInstanceDescription\":\"test\",\"DbNodeClass\":\"gdb.r.xlarge\",\"DbInstanceCategory\":\"ha\",\"ZoneId\":\"cn-hangzhou-h\",\"VpcId\":\"vpc-bp1bvsykm9f9hkfexxxxx\",\"VSwitchId\":\"vsw-bp152wgftimgq80exxxxx\",\"ResourceGroupId\":\"rg-acfmzaq3ypxxxxx\",\"DBInstanceIPArray\":[{\"SecurityIps\":\"10.10.10.10\"}],\"CreateType\":\"CreateDBInstance\",\"Tags\":[{\"TagKey\":\"cckey1\",\"TagValue\":\"ccvalue1\"},{\"TagKey\":\"cckey2\",\"TagValue\":\"ccvalue2\"}]}";
        //资源属性及其对应值
    ...
    private static boolean updateInstance(String resourceId) throws Exception {
        ...
        //资源属性及其对应值(json串,部分属性需改为自己账号对应的值)
        String resourceAttributes = "{\"ResourceGroupId\":\"rg-aek2xl5qajxxxxx\",\"SecurityResourceType\":\"DbInstance\",\"EcsSecurityGroupRelations\":[{\"SecurityGroupId\":\"sg-bp1h8h2esmn7xupxxxxx\"}],\"DbNodeStorage\":100,\"DBInstanceIPArray\":[{\"DbInstanceIpArrayName\":\"test1\",\"SecurityIps\":\"10.10.10.10,11.11.11.11\"},{\"DbInstanceIpArrayName\":\"default\",\"SecurityIps\":\"10.10.10.10\"}],\"DbInstanceDescription\":\"update\",\"Tags\":[{\"TagKey\":\"cckey2\",\"TagValue\":\"ccvalue2\"},{\"TagKey\":\"cckey3\",\"TagValue\":\"ccvalue3\"}]}";
        //资源属性及其对应值
        Map<String, Object> resourceAttributeMap = JSONObject.parseObject(resourceAttributes,Map.class);
