...
if __name__ == '__main__':
    ...
    request_path = "/api/v1/providers/Aliyun/products/HBR/resources/Vault"
    # 地域
    ...
    try:
        # 初始化sdk
        cloud_control_client = VaultSample.create_client()
        # 创建资源
        resource_id = VaultSample.create_vault()
        resource = VaultSample.get_vault(resource_id)
        print(resource)
        # 更新资源
        update_success = VaultSample.update_vault(resource_id)
        # 查询资源
        resource2 = VaultSample.get_vault(resource_id)
        print(resource2)
        # 列举资源
        resources = VaultSample.list_vaults()
        for item in resources:
            print(item)
        # 删除资源
        delete_success = VaultSample.delete_vault(resource_id)
