...
class InstanceSample:
    ...
    def create_instance(
        ...
        resource_attribute_map = {
            "InstanceName":"tf-testacc-cc-test-03",
            "ProductCode":"acr",
            ...
            "ResourceGroupId":"rg-aekz77t5qixxxxx"
        }
    ...
    def update_instance(
        ...
        """
        # 资源属性及其对应值（json字符串）
        resource_attribute_map = {"ResourceGroupId":"rg-aekz77t5qixxxxx"}
...
if __name__ == '__main__':
    ...
    request_path = "/api/v1/providers/Aliyun/products/CR/resources/Instance"
    # 地域
